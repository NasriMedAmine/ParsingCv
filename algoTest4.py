    ...
    SECTION_HEADERS = {
        ...
        "experience": {
            ...
            "aLotOfWords": [
                ...
                "détail des expériences professionnelles", "Détail Des Expériences Professionnelles",
    ...
    def hedhiTrajaaliChildrenMotCle(self, result: dict, liste: list) -> dict:
        try:
                ...
                for page_number, page in enumerate(pdf.pages, start=1):
                    ...
                    for line_number, line_words in enumerate(lines, start=1):
                        ...
                        if current_headers:
                            ...
                            # Multiple headers in same line:
                            # EXPERIENCE      COMPETENCE
                            # This starts/refreshes the active columns together.
                            ...
                            # One header alone:
                            # If it appears under an existing active column, replace that column.
            ...
            return {
                ...
                "data": self._clean_children_to_text_only(final_sections),
            }
